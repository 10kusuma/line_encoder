...
// Global variables
int bit_seq_len_global;
 // stores the length of generated bit stream.
string long_pal_str;
 // stores the longest palindromic substring.
vector<int> bit_seq_gen_global;
 // stores the binary bit stream 
vector<int> bit_seq_encoded_global; 
// stores the voltage level from graph used for decoding signal back to bit stream.
